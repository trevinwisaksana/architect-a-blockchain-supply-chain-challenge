...
contract SupplyChain is Ownable, DistributorRole, ConsumerRole, FarmerRole, RetailerRole {
    ...
    function processItem(uint _upc) public onlyFarmer harvested(_upc) verifyCaller(owner()) {
    ...
    function packItem(uint _upc) public onlyFarmer processed(_upc) verifyCaller(owner()) {
        // Update the appropriate fields
    ...
    function sellItem(uint _upc, uint _price) public onlyFarmer packed(_upc) verifyCaller(owner()) {
        // Update the appropriate fields
    ...
    function shipItem(uint _upc) public onlyDistributor sold(_upc) verifyCaller(owner()) {
        // Update the appropriate fields
